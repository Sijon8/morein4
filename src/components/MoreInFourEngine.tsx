...
export default function MoreInFourEngine() {
  ...
  const chartData = useMemo(() => {
    ...
    for (let year = 0; year <= 42; year++) {
      ...
      // Traditional Path: Starts investing at 28
    ...
    <div className="space-y-10 max-w-7xl mx-auto pt-8">
      ...
      <div className="text-center space-y-6 max-w-4xl mx-auto pb-6 border-b border-slate-800">
        <h1 className="text-4xl md:text-6xl font-black text-white uppercase italic tracking-tighter leading-none">
          More in four years <br/><span className="text-blue-500">than most in a lifetime.</span>
        </h1>
        
        <button 
          onClick={() => setShowNarrative(!showNarrative)}
          className="mx-auto flex items-center gap-2 bg-slate-900 border border-slate-700 hover:border-blue-500 text-slate-300 px-6 py-2 rounded-full text-xs font-bold uppercase tracking-widest transition-all"
        >
          <Info size={16} className="text-blue-500" />
          {showNarrative ? 'Hide The Strategy' : 'Read The Strategy'}
          {showNarrative ? <ChevronUp size={16} /> : <ChevronDown size={16} />}
        </button>

        {showNarrative && (
          <div className="bg-slate-900/80 p-8 rounded-2xl border border-blue-500/30 text-left space-y-5 shadow-xl text-slate-300 text-sm leading-relaxed mt-6 animate-in fade-in slide-in-from-top-4">
            <p>
              <strong className="text-white">The Traditional Route:</strong> For many young adults, the years between 18 and 22 are defined by taking on significant student debt to finance their education. They often spend their 20s paying off these loans, which naturally delays their ability to build a financial safety net or invest until their late 20s or 30s. The result? The median retirement savings for Americans approaching retirement age is currently around $185,000.
            </p>
            <p>
              <strong className="text-white">The Upfront Strategy:</strong> This approach is about making a massive power move early on. By enlisting at 18, you enter an environment where your largest overhead expenses—housing, food, and medical—are completely covered. Your cost of living drops remarkably close to zero.
            </p>
            <p>
              Instead of navigating debt, you have a unique four-year window to capture an incredibly high savings rate. You plant a compounding financial seed in your TSP and Roth IRA while life is lean and uncomplicated. By age 22, you emerge with a powerful wealth engine, a $300,000 GI Bill asset, and the financial freedom to pursue your next chapter on your own terms.
            </p>
          </div>
        )}
      </div>
      ...
      <div className="bg-slate-900/40 p-6 md:p-8 rounded-3xl border border-slate-800 shadow-2xl relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          <div className="group relative bg-slate-900 border border-slate-700 hover:border-blue-500 transition-colors p-6 rounded-2xl shadow-lg cursor-help">
            ...
            <p className="text-xs text-slate-500 mt-2 border-b border-dashed border-slate-600 inline-block">The Upfront Safety Net</p>
        ...
        <div className="h-[450px] w-full">
          <Line 
            data={{
              ...
              datasets: [
                { label: '4-Year Aggressive Upfront Strategy', data: chartData.milPoints, borderColor: '#3b82f6', tension: 0.4, pointRadius: 0, fill: true, backgroundColor: 'rgba(59, 130, 246, 0.1)', borderWidth: 3 },
                { label: 'Traditional Path (Starts at Age 28)', data: chartData.civPoints, borderColor: '#475569', borderDash: [5, 5], tension: 0.4, pointRadius: 0, borderWidth: 2 }
              ]
            }}
            options={{ 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
          ...
          <div className="bg-slate-900 p-6 rounded-2xl border border-slate-800 shadow-xl">
            ...
            <InfoRow 
              ...
              tooltip="Basic Allowance for Subsistence. Toggle this off if you are an E-1/E-2 eating exclusively at the base dining facility."
          ...
          <div className="bg-slate-900 p-6 rounded-2xl border border-slate-800 shadow-xl">
            ...
            <InfoRow 
              ...
              tooltip="Because military housing and food allowances are 100% tax-free, your actual tax burden is artificially low." 
            ...
            <InfoRow 
              ...
              tooltip="A lean, manageable budget." 
              receipts="Conservative estimate for cell phone, car insurance, internet, and minor subscriptions while living on base."
            />
            <InfoRow 
